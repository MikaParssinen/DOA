...
void menuTree(BSTree tree)
{
    ...
    do
    {
        ...
        switch(choice)
        {
            ...
            case 13: printf("Enter how many of the largest numbers you want to summarise: ");
                     scanf("%d", &k);
                     sumBiggest(tree, k); break;
